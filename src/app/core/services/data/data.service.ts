    ...
    },
    {
      ...
      menu: [
        /*
        {
          ...
          subMenus: [
            {
              menuValue: 'Documents administrat',
              route: routes.admin,
              base: 'admin',
              base2: 'sdhkjh',
              haseSubSubMenu: true,
              ...
              SubSubMenu: [
                {
                  menuValue: 'Acte de naissance',
                  route: routes.admin,
                },
                {
                  menuValue: 'carte ID ou du passeport',
                  route: routes.admin,
                },
                {
                  menuValue: 'Attestation de résidence',
                  route: routes.admin,
                },
                {
                  menuValue: 'Carte CNSS',
                  route: routes.admin,
                },
              ],
            },
            {
              menuValue: 'Documents recru',
              route: routes.admin,
              base: 'admin',
              base2: 'sdhkjh',
              haseSubSubMenu: true,
              SubSubMenu: [
                {
                  menuValue: 'Lettre de motivation',
                  route: routes.admin,
                },
                {
                  menuValue: 'Curriculum vitae',
                  route: routes.admin,
                },
                {
                  menuValue: 'Attestations de travail',
                  route: routes.admin,
                },
              ],
            },
            {
              menuValue: 'Documents de service',
              route: routes.admin,
              base: 'admin',
              base2: 'sdhkjh',
              haseSubSubMenu: true,
              SubSubMenu: [
                {
                  menuValue: 'Fiche de poste',
                  route: routes.admin,
                },
                {
                  menuValue: 'Contrat de travail',
                  route: routes.admin,
                },
                {
                  menuValue: 'Lettre de notification d’embauche',
                  route: routes.admin,
                },
              ],
            },
            {
              menuValue: 'Documents personnels',
              route: routes.admin,
              base: 'admin',
              base2: 'sdhkjh',
              haseSubSubMenu: true,
