...
import {ExportsService, routes, banqueService, getFamille, getBureau} from 'src/app/core/core.index';
...
export class FamilleComponent implements OnInit {
  ...
  public lstFamille: Array<getFamille> = [];
  public searchDataValue = '';
  dataSource!: MatTableDataSource<getFamille>;
  ...
  constructor(private formBuilder: FormBuilder,public router: Router, private data: FamilleService, private exp: ExportsService) {}
...
getDeleteForm(row: any){
  ...
  private getTableData(): void {
    ...
    this.data.getAll().subscribe((res: any) => {
      ...
      res.data.data.map((res: getFamille, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<getFamille>(this.lstFamille);
