...
import { routes, AttributionRoleService, getMiniTemplateEmploye, getRole, ExportsService } from 'src/app/core/core.index';
...
export class AttributionRoleComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, public router: Router, private data: AttributionRoleService, private exp: ExportsService) {}
...
getEditForm(row: any){
  ...
  exportToPDF() {
    ...
    this.exp.exportAttributionRoles().subscribe(
      (response: any) => {
