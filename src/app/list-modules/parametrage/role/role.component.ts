...
import { ExportsService, routes, roleService, getRole  } from 'src/app/core/core.index';
...
export class RoleComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,public router: Router, private data: roleService, private exp: ExportsService) {}
...
exportToPDF() {
  $('#spinner_pdf').removeClass('d-none');
    this.exp.exportRoles().subscribe(
      (response: any) => {
