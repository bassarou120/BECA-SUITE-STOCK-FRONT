...
// Fermer le modal en simulant un clic sur le bouton X
            ...
            if (this.importReport.ignored.length > 0) {
                ...
                this.showToast(
                    ...
                    `${this.importReport.success_count} employé(s) importé(s), ${this.importReport.ignored.length} ligne(s) ignorée(s).`
                );
            } else {
                ...
                this.showToast(
                    'success',
                    'Importation Réussie !',
                    `${this.importReport.success_count} employé(s) importé(s) avec succès.`
                );
