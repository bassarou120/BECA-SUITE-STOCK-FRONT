...
import { ExportsService, getFormation, routes, FormationsService,getMiniTemplateEmploye } from 'src/app/core/core.index';
...
export class FormationsComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,public router: Router,private data: FormationsService, private exp: ExportsService) {}
  ...
  exportToPDF() {
    ...
    this.exp.exportFormations().subscribe(
      (response: any) => {
